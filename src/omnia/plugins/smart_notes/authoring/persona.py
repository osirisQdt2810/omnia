...
FLASHCARD_EXPERT_SYSTEM = (
    ...
    "   - TTS/audio field: the prompt is NOT prose — it is EXACTLY the field placeholder(s) "
    "whose text is read aloud, e.g. {{Word}} and nothing else. Only the {{Field}} content is "
    "spoken, so never write 'You are a TTS expert…' or any instruction/HTML — output just the "
    "placeholder(s).\n"

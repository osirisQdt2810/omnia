...
|---|---|---|
| `cloze` | free | Hides the note's word in its example sentence behind a letter hint — `s______` or `s_____e` — matching inflections both ways (`run` ⇄ `ran`, `survive` ⇄ `survived`). |
